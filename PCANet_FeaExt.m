...
OutImg = InImg; 
%fprintf('size of InImg is %dx%dx%d\n',size(InImg{1},1),size(InImg{1},2),size(InImg{1},3))
ImgIdx = (1:NumImg)';
%clear InImg;
...
%fprintf('size of OutImg is %dx%dx%d\n',size(OutImg{1},1),size(OutImg{1},2),size(OutImg{1},3))
%save
